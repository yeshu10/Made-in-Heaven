 ...
 if(isset($_GET["ID"]))
	{
		...
		$a="select * from venues where  ID='$ID'";
...
?> 
    ...
    <form action="V_Detail.php"method="GET">
          <input type="date" name="V_DATE" min=<?php echo date('Y-m-d');?> required style="float: left; height: 70px;width: 350px;margin-top:10px;margin-left:80px;font-size:22pt;font-weight:bold">
