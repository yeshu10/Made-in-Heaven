 ...
 if(isset($_GET["ID"]))
	{
		...
		$a="select * from photographer where  ID='$ID'";
...
?> 
    ...
    <form action="P_Detail.php"method="GET">
          <input type="date" name="P_DATE" min=<?php echo date('Y-m-d');?> required style="float: left;
